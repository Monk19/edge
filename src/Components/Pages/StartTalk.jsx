...
export default function StatTalk() {
  return(
          <div className="startTalk container-fluid" id="starttalk" >
          <div className="row contact-padding">
          <div className="col-6">
          <span className="page-suggester">OUR SUCCESS OVER THE YEARS</span>
          <h1>
            Stats Talk
            <span className="red-spammers"> For themselves</span>
          </h1>
          <p>
          ...
          <button>Read more</button>
              ...
              <div className="col-6">
              <div className="Serv-photo-div talk-per">
        <div>
          <h1>90%</h1>
