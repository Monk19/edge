...
import "./Training.modules.css";
import build from "../../Assets/Images/build.png";
import group from "../../Assets/Images/thegang.png";
import cloud from "../../Assets/Images/cloud.png";
import present from "../../Assets/Images/present.png";
import seriousdude from "../../Assets/Images/seriousdude.png";

export default function TrainingConsult() {
  return (
    <div className="training-services container">
      <div className="row serv-feaatures">
        <div className="col-md-4 col-sm-12">
          <img src={build} alt="buildings"></img>
          <div>
            ...
            <p>
              ...
              history of lorem ipsum.empor incididunt ut labore et dolore magna
        ...
        <div className="col-md-4 col-sm-12">
          <img src={cloud} alt="buildings"></img>
          <div>
            <h2>Staff Augmentation</h2>
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
        ...
        <div className="col-md-4 col-sm-12">
          <img src={present} alt="buildings"></img>
          <div>
            <h2>Staff Augmentation</h2>
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
      ...
      <div className="row serv-feaatures">
        <div className="col-md-4 col-sm-12">
          <img src={seriousdude} alt="buildings"></img>
          <div>
            <h2>Staff Augmentation</h2>
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
        ...
        <div className="col-md-4 col-sm-12">
          <img src={group} alt="buildings"></img>
          <div>
            <h2>Staff Augmentation</h2>
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
