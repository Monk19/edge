...
import studgroup from "../../Assets/Images/studgroup.png";
      ...
      <div className="row">
        <div className="col-6">
          <div className="christina-img">
            <img src={studgroup} className="stud-group"></img>
          </div>
        </div>
        <div className="col-6 carrers-content">
          <span className="page-suggester">Carrers</span>
          <h1>
            Become an Industry
            <span className="red-spammers"> Professional</span>
          </h1>
          <p>
